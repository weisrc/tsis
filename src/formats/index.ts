/* 
This file is based on https://github.com/ajv-validator/ajv-formats/blob/master/src/formats.ts.
License of ajv-formats included in __dirname.
*/
...
export const jsonPointer = /^(?:\/(?:[^~/]|~0|~1)*)*$/;
export const jsonPointerUriFragment =
	/^#(?:\/(?:[a-z0-9_\-.!$&'()*+,;:=@]|%[0-9a-f]{2}|~0|~1)*)*$/i;
// relative JSON-pointer: http://tools.ietf.org/html/draft-luff-relative-json-pointer-00
export const relativeJsonPointer = /^(?:0|[1-9][0-9]*)(?:#|(?:\/(?:[^~/]|~0|~1)*)*)$/;
...
export function time(str: string, withTimeZone?: boolean): boolean {
